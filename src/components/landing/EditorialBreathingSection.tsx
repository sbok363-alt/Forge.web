...
export const EditorialBreathingSection: React.FC = () => {
  return (
    <section className="py-24 sm:py-36 bg-[#050505] relative overflow-hidden border-t border-white/[0.05]">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        <p className="mt-8 sm:mt-10 max-w-xl mx-auto text-sm sm:text-base text-[#8E8E93] leading-relaxed font-normal">
