...
export const SectionB_Evidence: React.FC = () => {
  ...
  return (
    <section id="section-progress" className="pt-12 sm:pt-16 lg:pt-24 pb-8 sm:pb-12 lg:pb-24 bg-[#050505] relative scroll-mt-20 sm:scroll-mt-24">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mb-8 sm:mb-12 lg:mb-16">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/[0.04] border border-white/[0.08] mb-3 sm:mb-4">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-white uppercase tracking-tight leading-[1.12] pb-1 mb-3 sm:mb-4">
            Progress you can{' '}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FF7A32] to-[#FF9457] inline-block">
              prove.
            </span>
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 sm:gap-6">
          ...
          <div className="lg:col-span-7 bg-[#0C0C0E] border border-white/[0.08] rounded-2xl sm:rounded-3xl p-4 sm:p-6 lg:p-8 flex flex-col justify-between shadow-xl">
            {/* Header + Time Filter */}
            <div>
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-4 pb-4 border-b border-white/[0.06] mb-5 sm:mb-6">
                <div>
              ...
              {/* Bar Graph Visual */}
              <div className="h-48 sm:h-56 pt-6 pb-2 flex items-end justify-between gap-2 sm:gap-3 px-1 sm:px-2 border-b border-white/[0.08] relative">
                ...
                {chartPoints.map((pt, idx) => (
                  ...
                  >
                    {/* Tooltip value */}
                    <div
                      className={`transition-opacity bg-black border text-[10px] font-mono py-0.5 px-1.5 sm:px-2 rounded mb-2 whitespace-nowrap shadow-lg ${
                        idx === chartPoints.length - 1
                          ? 'opacity-100 border-[#FF7A32]/50 text-[#FF7A32]'
                          : 'opacity-0 group-hover:opacity-100 border-white/20 text-white'
                      }`}
                    >
            ...
            <div className="grid grid-cols-3 gap-2 sm:gap-3 pt-4 sm:pt-6 mt-2">
              <div className="p-2.5 sm:p-3 rounded-xl sm:rounded-2xl bg-black/40 border border-white/[0.05]">
                <div className="text-base sm:text-lg font-extrabold text-white">12</div>
                <div className="text-[10px] sm:text-[11px] text-[#8E8E93] leading-tight">Workouts completed</div>
              </div>
              <div className="p-2.5 sm:p-3 rounded-xl sm:rounded-2xl bg-black/40 border border-white/[0.05]">
                <div className="text-base sm:text-lg font-extrabold text-emerald-400">+6.8%</div>
                <div className="text-[10px] sm:text-[11px] text-[#8E8E93] leading-tight">Strength gain</div>
              </div>
              <div className="p-2.5 sm:p-3 rounded-xl sm:rounded-2xl bg-black/40 border border-white/[0.05]">
                <div className="text-base sm:text-lg font-extrabold text-[#FF7A32]">5 PRs</div>
                <div className="text-[10px] sm:text-[11px] text-[#8E8E93] leading-tight">Records logged</div>
              </div>
            </div>
          </div>

          {/* Muscle Distribution & Anatomical Evidence (5 cols) */}
          <div className="lg:col-span-5 bg-[#0C0C0E] border border-white/[0.08] rounded-2xl sm:rounded-3xl p-4 sm:p-6 lg:p-8 flex flex-col justify-between shadow-xl">
            <div>
              <div className="flex items-center justify-between pb-4 border-b border-white/[0.06] mb-3 sm:mb-4">
                <div>
              ...
              {/* Distribution bars */}
              <div className="space-y-2.5 sm:space-y-3.5 my-3 sm:my-4">
            ...
            <div className="p-3 sm:p-3.5 rounded-xl sm:rounded-2xl bg-black/50 border border-white/[0.06] text-xs text-[#8E8E93] flex items-center justify-between mt-3 sm:mt-0">
